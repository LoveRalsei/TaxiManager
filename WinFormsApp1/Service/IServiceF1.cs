...
namespace TaxiManager.Service
{
    ...
    public interface IServiceF1
    {
        ...
        /// </summary>
        public abstract F1RenderMode GetRenderMode(RectLatLng viewArea, Size gmapSize);
        public abstract List<PointLatLng> GetPoints(RectLatLng viewArea, Size gmapSize, DateTime time);
        public abstract List<(Tile tile, uint count)> GetTiles(RectLatLng viewArea, Size gmapSize, DateTime time);
        /// <summary>
